...
const homeSpots = [
  {
    id:'sonMon', label:'Sơn Môn', shape:'rect', x:50.4, y:77.1, w:18.2, h:10.0, action:'intro'
  },
  {
    id:'chinhDien', label:'Chính điện', shape:'rect', x:49.9, y:32.7, w:16.6, h:10.5, action:'goto-org'
  },
  {
    id:'truongLaoDuong', label:'Trưởng Lão Đường', shape:'rect', x:19.4, y:29.3, w:18.8, h:9.6, action:'info',
    kicker:'Ban chuyên môn',
    title:'Trưởng Lão Đường',
  ...
  {
    id:'chapPhapDuong', label:'Chấp Pháp Đường', shape:'rect', x:16.0, y:45.9, w:18.6, h:9.6, action:'info',
    kicker:'Ban điều hành',
    title:'Chấp Pháp Đường',
  ...
  {
    id:'thienCongVien', label:'Thiên Công Viện', shape:'rect', x:16.0, y:66.1, w:18.5, h:10.0, action:'info',
    kicker:'Nghiên cứu – chế tạo',
    title:'Thiên Công Viện',
  ...
  {
    id:'lichLuyenThap', label:'Lịch Luyện Tháp', shape:'rect', x:72.0, y:29.9, w:18.5, h:10.0, action:'info',
    kicker:'Đào tạo – rèn luyện',
    title:'Lịch Luyện Tháp',
  ...
  {
    id:'tangKinhThap', label:'Tàng Kinh Tháp', shape:'rect', x:90.5, y:29.5, w:17.4, h:10.0, action:'info',
    kicker:'Tài liệu – tri thức',
    title:'Tàng Kinh Tháp',
  ...
  {
    id:'thiLuyenTruong', label:'Thí Luyện Trường', shape:'rect', x:81.5, y:52.1, w:20.6, h:10.0, action:'maze'
  },
  {
    id:'mazeEvent', label:'Robot Mê Cung đang diễn ra', shape:'poster', x:81.5, y:50.5, w:6.1, h:10.9, action:'maze', image:'assets/maze-poster.webp'
  },
  {
    id:'xuatChinhDuong', label:'Xuất Chinh Đường', shape:'rect', x:73.7, y:71.2, w:18.7, h:10.0, action:'info',
    kicker:'Thi đấu – đội tuyển',
    title:'Xuất Chinh Đường',
  ...
  {
    id:'anhHungBang', label:'Anh Hùng Bảng', shape:'rect', x:91.2, y:65.5, w:16.8, h:10.0, action:'info',
    kicker:'Vinh danh thành tích',
    title:'Anh Hùng Bảng',
  ...
  {
    id:'giangHoLenh', label:'Giang Hồ Lệnh', shape:'rect', x:91.0, y:85.3, w:17.0, h:10.0, action:'info',
    kicker:'Thông báo – chỉ thị',
    title:'Giang Hồ Lệnh',
...
const orgSpots = [
  { id:'chairman', label:'Chủ nhiệm', shape:'round', x:50.0, y:24.2, w:12.5, h:18.5, type:'profile', profileId:'chairman' },
  {
    id:'vice', label:'Phó Chủ nhiệm', shape:'round', x:50.0, y:43.2, w:10.6, h:15.2, type:'info',
    kicker:'Ban Chủ nhiệm',
    title:'Phó Chủ nhiệm',
  ...
  {
    id:'mechanics', label:'Cơ khí – Kết cấu', shape:'round', x:13.6, y:54.1, w:9.8, h:13.8, type:'info',
    kicker:'Ban chuyên môn',
    title:'Cơ khí – Kết cấu',
  ...
  {
    id:'electronics', label:'Điện – Điện tử', shape:'round', x:25.8, y:54.1, w:9.8, h:13.8, type:'info',
    kicker:'Ban chuyên môn',
    title:'Điện – Điện tử',
  ...
  {
    id:'control', label:'Lập trình – Điều khiển', shape:'round', x:37.5, y:54.1, w:9.8, h:13.8, type:'info',
    kicker:'Ban chuyên môn',
  ...
  {
    id:'planning', label:'Kế hoạch – Hành chính', shape:'round', x:58.2, y:54.1, w:8.2, h:13.2, type:'info',
    kicker:'Ban điều hành',
    title:'Kế hoạch – Hành chính',
  ...
  {
    id:'training', label:'Đào tạo – Thành viên', shape:'round', x:66.4, y:54.0, w:8.2, h:13.2, type:'info',
    kicker:'Ban điều hành',
    title:'Đào tạo – Thành viên',
  ...
  {
    id:'events', label:'Sự kiện – Thi đấu', shape:'round', x:74.2, y:54.0, w:8.2, h:13.2, type:'info',
    kicker:'Ban điều hành',
    title:'Sự kiện – Thi đấu',
  ...
  {
    id:'logistics', label:'Hậu cần – Kỹ thuật', shape:'round', x:82.2, y:54.0, w:8.2, h:13.2, type:'info',
    kicker:'Ban điều hành',
    title:'Hậu cần – Kỹ thuật',
  ...
  {
    id:'media', label:'Truyền thông – Đối ngoại', shape:'round', x:90.0, y:54.0, w:8.2, h:13.2, type:'info',
    kicker:'Ban điều hành',
    title:'Truyền thông – Đối ngoại',
  ...
  { id:'outerMembers', label:'Ngoại môn đệ tử', shape:'rect', x:16.0, y:84.8, w:24.5, h:23.0, type:'members', memberGroupId:'outerMembers' },
  { id:'innerMembers', label:'Nội môn đệ tử', shape:'rect', x:50.0, y:84.8, w:23.5, h:23.0, type:'members', memberGroupId:'innerMembers' },
  { id:'coreMembers', label:'Chân truyền đệ tử', shape:'rect', x:84.1, y:84.8, w:25.0, h:23.0, type:'members', memberGroupId:'coreMembers' }
];
...
function safeText(value){
  return value && String(value).trim() ? value : 'Đang cập nhật';
}

function switchPage(page){
  Object.entries(pages).forEach(([key, el]) => el.classList.toggle('is-active', key === page));
}
...
function replayScrollAnimation(){
  scrollCard.style.animation = 'none';
  void scrollCard.offsetWidth;
  scrollCard.style.animation = '';
}

function openModal(){
  modal.classList.add('open');
  modal.setAttribute('aria-hidden', 'false');
  replayScrollAnimation();
}
...
function openMessage({ kicker = '', title = '', body = 'Đang cập nhật', html = false } = {}){
  ...
  messageFields.kicker.textContent = kicker;
  messageFields.title.textContent = title;
  if (html) {
    messageFields.body.innerHTML = body;
  } else {
    messageFields.body.textContent = body;
  }
  openModal();
}
...
function openProfile(profile){
  ...
  profileFields.group.textContent = safeText(profile.group);
  profileFields.name.textContent = safeText(profile.name);
  profileFields.role.textContent = safeText(profile.role);
  profileFields.position.textContent = safeText(profile.position);
  profileFields.academicRank.textContent = safeText(profile.academicRank);
  profileFields.degree.textContent = safeText(profile.degree);
  profileFields.responsibility.textContent = safeText(profile.responsibility);
  profileFields.avatar.textContent = initials(profile.name);
  if (profile.email && profile.email.includes('@')) {
    profileFields.email.innerHTML = `<a href="mailto:${profile.email}">${profile.email}</a>`;
  } else {
    profileFields.email.textContent = safeText(profile.email);
  }
  openModal();
}
...
function openMembers(group){
  ...
  memberFields.group.textContent = group.group || '';
  memberFields.title.textContent = group.title || '';
  memberFields.tbody.innerHTML = '';
  group.members.forEach(member => {
    const tr = document.createElement('tr');
    const nameHTML = member.name && member.name.trim() ? member.name : '<span class="placeholder">Chưa cập nhật</span>';
    const classHTML = member.className && member.className.trim() ? member.className : '<span class="placeholder">Chưa cập nhật</span>';
    tr.innerHTML = `<td class="col-stt">${member.stt}</td><td>${nameHTML}</td><td>${classHTML}</td>`;
    memberFields.tbody.appendChild(tr);
  });
  openModal();
}
...
function openMazeCompetition(){
  openMessage({
    kicker: 'Thí Luyện Trường',
    title: 'Cuộc thi Robot Mê Cung',
    html: true,
    body: `
      <div class="maze-card">
        <div class="maze-poster-wrap">
          <img class="maze-poster" src="assets/maze-poster.webp" alt="Poster cuộc thi Robot Mê Cung" />
        </div>
        <div class="maze-copy">
          <div class="maze-title">ROBOT MÊ CUNG 2026</div>
          <div class="maze-desc">Sân chơi thực hành Robotics, lập trình và điều khiển tự động dành cho học viên, sinh viên. Nội dung thi kết hợp mê cung, line và vận hành robot tự động; là không gian rèn luyện kỹ năng chế tạo, tối ưu thuật toán và thi đấu thực chiến.</div>
          <div class="maze-note">Cuộc thi đang được giới thiệu tại khu vực <strong>Thí Luyện Trường</strong>.</div>
          <a class="maze-link" href="${MAZE_URL}" target="_blank" rel="noopener noreferrer">Vào trang cuộc thi →</a>
        </div>
      </div>`
  });
}
...
function createHotspot(item, index, clickHandler){
  ...
  button.type = 'button';
  const variantClass = item.shape === 'poster' ? 'poster-badge' : (item.shape === 'rect' ? 'rect' : 'round');
  button.className = `hotspot ${variantClass}`;
  button.style.left = `${item.x}%`;
  button.style.top = `${item.y}%`;
  button.style.width = `${item.w}%`;
  button.style.height = `${item.h}%`;
  button.style.setProperty('--delay', `${(index % 7) * 0.2}s`);
  button.setAttribute('aria-label', item.label);
  button.title = item.label;

  if (item.shape === 'poster' && item.image) {
    const posterThumb = document.createElement('span');
    posterThumb.className = 'poster-thumb';
    posterThumb.style.backgroundImage = `url("${item.image}")`;
    button.appendChild(posterThumb);
  }
...
function renderHomeSpots(){
  ...
  homeSpots.forEach((item, index) => {
    const button = createHotspot(item, index, () => {
      if (item.action === 'goto-org') {
        switchPage('org');
      } else if (item.action === 'intro') {
        openMessage({ kicker: 'Sơn Môn', title: 'Giới thiệu câu lạc bộ', body: INTRO_TEXT });
      } else if (item.action === 'maze') {
        openMazeCompetition();
      } else if (item.action === 'info') {
        openMessage({ kicker: item.kicker, title: item.title, body: item.body });
      } else {
        openMessage({ kicker: item.label, title: item.label, body: 'Đang cập nhật' });
      }
    });
  ...
  orgSpots.forEach((item, index) => {
    const button = createHotspot(item, index, () => {
      if (item.type === 'profile') {
        openProfile(staffProfiles[item.profileId]);
      } else if (item.type === 'members') {
        openMembers(memberGroups[item.memberGroupId]);
